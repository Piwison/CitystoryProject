      ...
      <div className="max-w-md mx-auto">
        <div className="mb-8 relative">
          <div className="w-32 h-32 bg-[#DBE2EF] rounded-full mx-auto flex items-center justify-center">
            <MapPin className="h-16 w-16 text-[#3F72AF]" />
          </div>
        ...
        <h1 className="text-3xl font-bold text-[#112D4E] mb-4">Oops! Place Not Found</h1>
        <p className="text-[#3F72AF] mb-8">
          We couldn&apos;t find the place you&apos;re looking for. It might have been removed or doesn&apos;t exist yet.
        </p>
        ...
        <div className="mt-8 pt-8 border-t border-[#DBE2EF]">
          <p className="text-gray-600 mb-4">Know this place? Help the community by adding it!</p>
