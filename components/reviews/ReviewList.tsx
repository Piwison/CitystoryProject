        ...
        <div className="grid grid-cols-2 gap-x-8 gap-y-2 mt-3">
          ...
          {review.service && (
            <div className="flex items-center justify-between">
              ...
              <StarRating value={review.service} readOnly size="sm" />
            </div>
          )}
          {review.value && (
            <div className="flex items-center justify-between">
          ...
          {review.atmosphere && (
            <div className="flex items-center justify-between">
              ...
              <StarRating value={review.atmosphere} readOnly size="sm" />
            </div>
          )}
        </div>
      );
        ...
        <div className="grid grid-cols-2 gap-x-8 gap-y-2 mt-3">
          {review.cleanliness && (
            <div className="flex items-center justify-between">
              ...
              <StarRating value={review.cleanliness} readOnly size="sm" />
            </div>
          )}
          {review.comfort && (
            <div className="flex items-center justify-between">
              <span className="text-sm text-gray-600">Comfort</span>
              <StarRating value={review.comfort} readOnly size="sm" />
            </div>
          )}
          {review.service && (
            <div className="flex items-center justify-between">
        ...
        <div className="grid grid-cols-2 gap-x-8 gap-y-2 mt-3">
          ...
          {review.variety && (
            <div className="flex items-center justify-between">
              ...
              <StarRating value={review.variety} readOnly size="sm" />
            </div>
          )}
        </div>
      );
